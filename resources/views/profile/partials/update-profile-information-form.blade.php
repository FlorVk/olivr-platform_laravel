    <div class="flex align-center width-40 justify-between">
    ...
    <form method="post" action="{{ route('profile.update') }}">
        ...
        <div class="flex justify-between align-center">
            <div class="width-100 flex flex-column">
                ...
                <input class="width-80 input-field" value="{{ $user->email }}" name="email" type="email" placeholder="email">
            </div>

            <div class="width-100 flex flex-column">
                <button class="btn btn-yellow width-80" type="submit">Update profiel</button>
