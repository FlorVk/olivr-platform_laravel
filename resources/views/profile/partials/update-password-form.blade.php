    ...
    <form method="post" action="{{ route('password.update') }}">
        ...
        <div class="flex justify-between align-center">
            <div class="width-100 flex flex-column">
                ...
                <x-text-input id="current_password" name="current_password" type="password" class="width-80 input-field" autocomplete="current-password" />
                <x-input-error :messages="$errors->updatePassword->get('current_password')" />
            </div>

            <div class="width-100 flex flex-column">
                <button class="btn btn-yellow width-80" type="submit">Update Wachtwoord</button>
